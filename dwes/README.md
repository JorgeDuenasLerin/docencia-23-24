...
> Generación de APIs, GrapQL, Autentificación
...
Se requiere sacar un nota ```>=5``` en cada parte para hacer media. La nota de la evaluación será la media ponderada.

La nota del módulo será la media por evaluaciones.

En el caso suspender alguna evaluación no se contempla recuperación, se puede aprobar del contenido de esa evaluación en el examen ordinario.
...
A los largo del curso se realizarán varias exposiciones del trabajo.
